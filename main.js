...
$('#muscleCars').click(function(){
    ...
    $('#infoSlider').find('h1').text('Muscle Cars');

    $('#infoSlider').find('p').text('Los Muscle Cars son vehículos de tamaño mediano o grande, con un diseño deportivo y “musculoso”. Son conocidos por su potente motor, generalmente un V8, y su tracción trasera1. Aunque no son lujosos, su aspecto agresivo y su alto rendimiento los hacen muy llamativos. ');
});
...
$('#sedanesTurbo').click(function(){
    ...
    $('#infoSlider').find('h1').text('Sedanes Turbo');

    $('#infoSlider').find('p').text('Los sedanes turbo son vehículos de cuatro puertas con un motor turbocargado que mejora la eficiencia y el rendimiento. Ofrecen una combinación de lujo, comodidad y potencia. Son ideales para aquellos que buscan un coche espacioso y cómodo, pero también desean una experiencia de conducción emocionante y dinámica123.');
});
...
$('#sedanesDeLujoTurbo').click(function(){
    ...
    $('#infoSlider').find('h1').text('Sedanes de Lujo Turbo');
...
$('#pickups').click(function(){
    ...
    $('#infoSlider').find('h1').text('PickUps');
...
$('#clasicos').click(function(){
    ...
    $('#infoSlider').find('h1').text('Clásicos');

    $('#infoSlider').find('p').text('Los coches clásicos son vehículos antiguos, generalmente de más de 30 años, que destacan por su diseño y tecnología de época. Son apreciados por su belleza, historia y singularidad. A menudo se conservan o restauran a su estado original y se exhiben en exposiciones y desfiles.');
});
...
$('#motos').click(function(){
    ...
    $('#infoSlider').find('h1').text('Motos');

    $('#infoSlider').find('p').text('Las motos deportivas son máquinas de alta velocidad diseñadas para la pista. Destacan por su potencia, aerodinámica y tecnología avanzada. Su diseño agresivo y posición de conducción inclinada maximizan el rendimiento y la velocidad. Son ideales para los entusiastas de las carreras y la adrenalina.');
});
...
$('#suvseuropeas').click(function(){
    ...
    $('#infoSlider').find('h1').text('Suv Europeas');

    $('#infoSlider').find('p').text('Los SUV europeos combinan funcionalidad y lujo. Son vehículos robustos, diseñados para todo terreno, pero con un interior refinado. Ofrecen espacio, seguridad y comodidad, con tecnología de vanguardia. Los modelos europeos, como los de BMW, Mercedes y Audi, son conocidos por su rendimiento y calidad superior.');
});
